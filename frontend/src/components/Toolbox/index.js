...
const Toolbox = () => {
  ...
  return (
    ...
    >
      {isMinimized ? (
        <button
          className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md p-2.5 rounded-xl shadow-lg hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all duration-150 border border-slate-200/60 dark:border-zinc-800/60 text-slate-600 dark:text-zinc-400 flex items-center justify-center"
